...
const OrderCreateScreen = props => {
  ...
  const submitData = async () => {
    const url = `https://server.fitlive.fit/createOrder`;
    const headers = {
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Fetch
                  url={`https://server.fitlive.fit/getClient?userId=${encodeURIComponent(
         ...
         <Picker.Item label={prop.fullName} value={prop.clientId} />
          ...
          >
            ...
            >
              ...
              >
                <Fetch
                  url={`https://server.fitlive.fit/getCoach?userId=${encodeURIComponent(
                    props.route.params['userId']
                  )}`}
                  headers={{
                    Accept: 'application/json',
