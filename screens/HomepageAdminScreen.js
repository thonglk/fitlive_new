  ...
  const loadUserData = async () => {
    ...
    try {
      const response = await fetch(
        `https://server.fitlive.fit/user?userId=${encodeURIComponent(
  ...
  return (
    <ScreenContainer scrollable={true} hasSafeArea={true}>
      ...
      >
        ...
        <Fetch
          url={`https://server.fitlive.fit/user?userId=${encodeURIComponent(
            props.route.params['userId']
          )}`}
          headers={{
              ...
              >
                ...
                >
                  <Touchable
                    ...
                    style={data && data['permission_session_create']  == false?{ display: "none" }:styles.Touchable_7U}
                  >
                    <View
                      style={StyleSheet.flatten([
                        styles.ViewTk,
