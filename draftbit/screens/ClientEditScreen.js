...
const ClientEditScreen = props => {
  ...
  const fetchData = async () => {
    setLoader('Loading...');
    const url = `https://fitlive.glitch.me/clientDetail?clientId=${props.route.params['clientId']}&userId=${props.route.params['userId']}&businessId=${props.route.params['businessId']}`;
    const headers = {
      Accept: 'application/json',
      'Content-Type': 'application/json',
    };
