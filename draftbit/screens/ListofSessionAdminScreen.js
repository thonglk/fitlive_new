...
const ListofSessionAdminScreen = props => {
  ...
  const downloadLink = async () => {
    var filter_url = `https://fitlive.glitch.me/sessionSearch?filter_coachId=${encodeURIComponent(
      filter_coachId
      ...
      >
        ...
        >
          ...
          >
                  ...
                  return (
                    ...
                    >
                      <TextInput
                        ...
                        autoCapitalize="none"
                        keyboardType="default"
                        value={filter_locationId}
                        onChangeText={filter_locationId =>
                          setFilter_locationId(filter_locationId)
                        }
                      />
                    </Container>
                  );
            ...
            >
              <Fetch
                url={`https://fitlive.glitch.me/getCoach?filter_locationId=${encodeURIComponent(
                  filter_locationId
                  ...
                  return (
                    ...
                    >
                      <TextInput
                        ...
                        autoCapitalize="none"
                        keyboardType="default"
                        value={filter_coachId}
                        onChangeText={filter_coachId =>
                          setFilter_coachId(filter_coachId)
                        }
                      />
                    </Container>
                  );
        ...
        <Fetch
          ...
          url={`https://fitlive.glitch.me/sessionSearch?filter_coachId=${encodeURIComponent(
            filter_coachId
          )}&filter_dayStart=${encodeURIComponent(
            filter_dayStart
          )}&filter_dayEnd=${encodeURIComponent(
